...
sudo cd
echo "alias $1.start='sudo systemctl start $1'" >> .bash_aliases
echo "alias $1.stop='sudo systemctl stop $1'" >> .bash_aliases
echo "alias $1.status='sudo systemctl -l status $1'" >> .bash_aliases
echo "alias $1.restart='sudo systemctl restart $1'" >> .bash_aliases